...
const MachineLearningSection = () => {
  return (
    <div className="lg:mx-8 bg-gradient-radial bg-gradient-to-b from-blue-50 via-blue-200 bg-gradient-radial dark:from-blue-900/10 dark:via-blue-600/20   rounded-xl flex flex-col mt-10 mb-10" id="machine-learning">
