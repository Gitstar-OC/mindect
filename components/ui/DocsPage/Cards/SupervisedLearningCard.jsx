...
const SupervisedLearningCard = () => {
  return (
    <CardSpotlight className="w-full max-w-xs sm:max-w-[80vw] lg:w-96 mx-auto relative">
      <span className="bg-purple-100 text-purple-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-full dark:bg-purple-900 dark:text-purple-300 relative">In Progress</span>
      <p className="text-xl font-bold relative z-20 mt-2 text-black dark:text-white">
        Supervised Learning
      </p>
      <div className="dark:text-neutral-200 mt-4 relative">
