    ...
    <CardSpotlight className="w-full max-w-full sm:max-w-[80vw] lg:w-96 mx-auto relative">
      ...
      <div className="dark:text-neutral-200 mt-4 relative z-20">
        ...
        <ul className="list-none mt-2 grid grid-cols-1 lg:grid-cols-1 md:grid-cols-2 gap-x-4">
          ...
          <Step title="Bias and Variance" />
          <Step title="Back Propagation" />
          <Step title="Multiclass Classification" />
          <Step title="Decision Trees, Trees Learning" />
          <Step title="Tree Ensembles" />
          <Step title="Neural Network Intuition" />
          <Step title="Skewed Datasets" />
        </ul>
      </div>
    </CardSpotlight>
  );
