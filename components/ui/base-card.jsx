...
// Default CheckIcon component with customizable className
...
const BaseCard = ({
  ...
  extraSteps = [],
  colors,
  iconColor = "text-blue-500" // Set a default icon color if none is provided
}) => {
  return (
    <>
      <ShineBorder
        className="relative flex-col md:w-[80vw] sm:w-[80vw] xl:mt-0 rounded-3xl xl:w-[22rem] xl:h-[29rem] mx-auto items-center sm:mt-4 justify-center overflow-hidden border bg-background md:shadow-xl"
        color={[`${colors}`]}
      >
        <div>
          ...
          <Link href={`learn/${buttonPath}`} passHref className="flex justify-center">
            <button className={cn("relative p-[3px] mt-6 mb-6", buttonStyle)}>
