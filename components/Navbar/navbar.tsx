...
const class1 = "group-hover:from-blue-50 group-hover:to-blue-200 dark:group-hover:from-blue-900/30 dark:group-hover:to-blue-600/50";
const class2 = "group-hover:from-purple-100 group-hover:to-purple-300 dark:group-hover:from-purple-900/30 dark:group-hover:to-purple-600/50";
const active1 = "bg-gradient-to-br from-blue-50 to-blue-200 dark:from-blue-900/30 dark:to-blue-600/50"
const active2 = "bg-gradient-to-br note from-purple-100 to-purple-300 dark:from-purple-900/30 dark:to-purple-600/50"
              ...
              <NavigationMenuContent>
                <ul className="flex flex-col gap-3 p-4 w-[300px] lg:grid-cols-[.75fr_1fr]">
                  <ListItem
                    ...
                    className={cn(class1, pathname.startsWith("/learn/sl") && active1)}
                  />
                  <ListItem
                    ...
                    className={cn(class1, pathname.startsWith("/learn/usl") && active1)}
                  />
                  <ListItem
                    ...
                    className={cn(class1, pathname.startsWith("/learn/algs") && active1)}
                  />
                </ul>
              </NavigationMenuContent>
            </NavigationMenuItem>
              ...
              <NavigationMenuContent>
                <ul className="flex flex-col gap-3 p-4 w-[300px] lg:grid-cols-[.75fr_1fr]">
                  <ListItem
                    ...
                    className={cn(class2, pathname.startsWith("/learn/algebra") && active2)}
                  />
                  <ListItem
                    title="Calculus"
                    ...
                    className={cn(class2, pathname.startsWith("/learn/calculus") && active2)}
                  />
                  <ListItem
                    title="Probability"
                    ...
                    className={cn(class2, pathname.startsWith("/learn/probability") && active2)}
                  />
                </ul>
              </NavigationMenuContent>
            </NavigationMenuItem>
