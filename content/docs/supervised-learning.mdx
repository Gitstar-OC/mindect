...
In this section of supervised learning, you can learn the following things.
...
- [Gradient Descent Implementation](./gradient-descent-for-logistic-regression)
...
![Image for Input (X) to Output (Y) and it's application](/SL/SVL1.1.png)
...
There are mainly two types of Supervised learning algorithms, one is [Regression Model](/docs/supervised-learning#regression-algorithm) and [Classification Algorithm](/docs/supervised-learning#regression-algorithm). Here are they in details.
...
![Regression: Housing Price Prediction Graph](/SL/SVL1.2.png)
...
![Regression: Housing Price Prediction Graph with a line](/SL/SVL1.3.png)
...
![Regression: Housing Price Prediction Graph with a line and curve](/SL/SVL1.4.png)
