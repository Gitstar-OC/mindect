 ...
 **To run the notebook, use the following command:** 
 ...
 You can learn more about jupyter notebook by [clicking here](https://jupyter.org/). You can also refer to the documentation of [Jupyter notebook](https://jupyter.org/install)
...
<Card href="/jupyterNotebooks/IntroductiontoJupyterNotebook.ipynb" title="Download Introductory Module" download="IntroductiontoJupyterNotebook.ipynb" target="_blank" />
