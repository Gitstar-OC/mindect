---
title: Get Started
description: Learn AI docs are made for everybody to learn things in the feild of Artificial Intelligence, Machine Learning , Deep Learning, Speech Recognition etc. 
---
...
The level of the notes are also marked as <kbd>Beginner Friendly</kbd>, <kbd>Intermidiate</kbd> and <kbd>Advanced</kbd>
